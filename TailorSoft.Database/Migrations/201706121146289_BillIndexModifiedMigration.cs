namespace TailorSoft.Database.Migrations
{
    ...
    public partial class BillIndexModifiedMigration : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Bills", "SuitMeasurements", c => c.String(maxLength: 440));
            AlterColumn("dbo.Bills", "JacketMeasurements", c => c.String(maxLength: 440));
            AlterColumn("dbo.Bills", "SafaryMeasurements", c => c.String(maxLength: 440));
            AlterColumn("dbo.Bills", "TrouserMeasurements", c => c.String(maxLength: 440));
            AlterColumn("dbo.Bills", "ShirtMeasurements", c => c.String(maxLength: 440));
            AlterColumn("dbo.Bills", "OtherMeasurements", c => c.String(maxLength: 440));
